...
class Strategy(ABC):
    ...
    def create_equity_order(self, action: str, symbol: str, quantity: int, spot: float):
        equity_order_row = pd.Series(
            {"action": action, "symbol": symbol, "spot": spot, "quantity": quantity}
        )
